...
class SHTC3():
    ...
    def get_sensor_id(self):
        self.i2c.writeto(self.I2C_ADDRESS, self.ID_REGISTER)
        time.sleep(0.5)
        self.sensor_id = self.i2c.readfrom(self.I2C_ADDRESS, 3)         
        return self.sensor_id
        
    def sensor_sleep(self):
        self.i2c.writeto(self.I2C_ADDRESS, str(self.CMD_SLEEP))

    def sensor_wakeup(self):
        self.i2c.writeto(self.I2C_ADDRESS, str(self.CMD_WAKEUP))
...
try:        
    sensor = SHTC3(0, scl = Pin(5), sda = Pin(4), freq=100_000)
    sensor.sensor_sleep()
    time.sleep(0.02)
